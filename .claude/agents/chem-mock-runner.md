---
name: chem-mock-runner
description: "Use this agent on review days (7, 14, 21) to assemble and administer a timed mock paper from the question banks, score it via the validator, and report weak topics below 70 percent. Committed mocks use original questions only."
