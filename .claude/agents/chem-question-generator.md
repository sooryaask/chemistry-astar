---
name: chem-question-generator
description: "Use this agent to build OCR-style exam question banks (1/2/3-mark trios) for specific spec points, written to content/questions/{specId}.json matching the generateQuestions schema. Use proactively on learning days. Original questions only."
