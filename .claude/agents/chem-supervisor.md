---
name: chem-supervisor
description: "Use this agent to run or complete a day of the chemistry-astar 21-day coordinator. Invoke for 'Run Day N' or 'Complete Day N' — it reads coordinator/schedule.json and state.json, dispatches the chem-* worker agents, collects their output, updates state and the dashboard, and commits."
