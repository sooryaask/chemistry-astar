---
name: chem-validator
description: "Use this agent to strictly mark answers against OCR criteria and to QA generated notes and question banks before they ship. The quality gate — run it on every new content file and on all mock answers. High-stakes marking, so it runs on Opus."
